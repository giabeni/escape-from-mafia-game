...
onready var pill_text: Label = $MarginContainer/VBoxContainer/Bottom/HSplitContainer/Right/PillCounter/PillsLabel
onready var capsules_text: Label = $MarginContainer/VBoxContainer/Bottom/HSplitContainer/Right/PillCounter2/CapsulesLabel
